...
function renderFilteredRequirements(data) {
    ...
    data.forEach((req) => {
        ...
        row.innerHTML =
            ...
            '<td>' + filled + '</td>' +
            '<td>' + balance + '</td>' +
            '<td>' + (req.recruiter || req.assignedRecruiter || "-") + '</td>' +
...
function clearRequirementForm() {
    ...
    const recruiter = document.getElementById("reqRecruiter");
    if (recruiter) {
        recruiter.value = "";
    }
...
function saveRequirement() {
    ...
    req.recruiter = document.getElementById("reqRecruiter").value.trim();
    req.assignedRecruiter = req.recruiter;
...
function editRequirement(index) {
    ...
    document.getElementById("reqRecruiter").value = req.recruiter || req.assignedRecruiter || "";
...
function searchRequirements() {
    ...
    const filtered = requirements.filter(r => {
        ...
        const recruiter = String(r.recruiter || r.assignedRecruiter || "").toLowerCase();
        return client.includes(text) || position.includes(text) || recruiter.includes(text);
    });
